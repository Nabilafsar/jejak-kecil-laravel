                    ...
                    <div class="konten-item border border-gray-200 rounded-xl p-4 relative">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipe_konten[]" onchange="toggleInput(this)"
                                ...
                                <option value="gambar" {{ $isi->tipe_konten === 'gambar' ? 'selected' : '' }}>Gambar</option>
                        ...
                        <div class="input-konten">
                            ...
                            @elseif($isi->tipe_konten === 'gambar')
                                <img src="{{ Storage::url($isi->isi_konten) }}" class="w-32 h-20 object-cover rounded-lg mb-2">
                            ...
                            @elseif($isi->tipe_konten === 'video')
                                <video controls class="w-full rounded-lg mb-2">
                                    <source src="{{ Storage::url($isi->isi_konten) }}">
                                </video>
                                <input type="file" name="isi_konten[]" accept=".mp4,.avi,.mov"
                                    class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
                                <input type="hidden" name="isi_konten[]" value="{{ $isi->isi_konten }}">
                                <p class="text-xs text-gray-400 mt-1">Kosongkan jika tidak ingin mengganti video.</p>
                            @endif
                        </div>
                    </div>
                    @endforeach
...
function toggleInput(select) {
    ...
    if (tipe === 'teks') {
        ...
        inputWrapper.innerHTML += `<input type="file" name="isi_konten[]" accept=".mp4,.avi,.mov"
            class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm">
            <p class="text-xs text-gray-400 mt-1">Format: MP4, AVI, MOV</p>`;
    }
}
