            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-[#033E8A]">
                        ...
                        <th class="text-white text-sm font-semibold px-6 py-4 text-left">Kategori</th>
                ...
                <tbody>
                    @forelse($modul as $item)
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                @if($item->kategori)
                                    <span class="text-xs font-medium px-2.5 py-1 rounded-full bg-blue-50 text-[#033E8A]">
                                        {{ $item->kategori }}
                                    </span>
                                @else
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('admin.modules.edit', $item->id) }}"
